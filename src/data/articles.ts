...
export const articles: ArticleModel[] = [
        ...
        sections: [
            ...
            },
            {
                ...
                paragraphs: [
                    ...
                    'Die beiden Teilplanungen nennen derzeit überschlägig **etwa 400 Wohnungen im Süden und etwa 200 im Norden**. Diese Zahlen sind noch grobe Planungswerte und nicht als exakte Addition zu verstehen. Der übergeordnete Rahmenplan nennt für das Gesamtgebiet weiterhin **bis zu rund 580 Wohnungen**.',
                ...
                paragraphs: [
                    ...
                    'Viele für die tatsächlichen Auswirkungen **entscheidende Fragen** werden erst **in den Bebauungsplanverfahren** geklärt.',
                    {
                        ...
                        items: [
                            ...
                            'Wie bleiben Grünpuffer zu Brumhagen und zum Trelder Moor erhalten?',
                            'Wo können Ausgleichsflächen entstehen und wie groß müssen diese sein?'
                        ],
                    },
                ],
            },
    ...
    },
    {
        ...
        category: 'Stadtplanung',
        introduction: [
            'Am Sprötzer Weg soll eine bisher nur teilweise genutzte Fläche neu geordnet werden. Der Bebauungsplan „Sprötzer Weg / An den Tennisplätzen“ wird deshalb geändert.',
            'Bisher war die freie Fläche vor allem für Einzelhandel vorgesehen. Künftig sollen dort auch soziale, kulturelle und sportliche Einrichtungen sowie Bildungs-, Freizeit- und Spielangebote möglich sein. Eine Kindertagesstätte ist derzeit das bekannteste konkrete Vorhaben, der Bebauungsplan ist aber bewusst breiter gefasst.',
        ],
        sections: [
            {
                title: 'Wo liegt das Gebiet?',
                paragraphs: [
                    'Das Plangebiet liegt am Sprötzer Weg zwischen der Straße „An den Tennisplätzen“ und der Bahnstrecke. Der aktuelle Änderungsbereich ist rund 0,9 Hektar groß. Westlich befindet sich der bestehende Lebensmittelmarkt.',
                ],
                image: {
    ...
    },
    {
        ...
        sections: [
            ...
            {
                title: 'Was erlaubt der Bebauungsplan bisher?',
                paragraphs: [
                    'Der geltende Bebauungsplan „Neue Ortsmitte Sprötze – Niedersachsenstraße“ setzt für das Grundstück unter anderem eine Grundflächenzahl von 0,3, eine offene Bauweise, **maximal ein Vollgeschoss**, eine **Traufhöhe von 4,50 Metern** und eine **Firsthöhe von 9,00 Metern** fest. Zusätzlich gelten feste Baugrenzen und Vorgaben zum Erhalt des vorhandenen Großbaumbestands.',
                ],
            },
            {
                title: 'Was soll davon abweichen?',
                paragraphs: [
                    'Für das neue Vorhaben sind **zwei Vollgeschosse**, eine maximale **Traufhöhe von 7,00 Metern** und eine maximale **Firsthöhe von 11,00 Metern** vorgesehen.',
                    'Auch die **Baugrenzen sollen überschritten werden**: beim östlichen Gebäude um etwa **1,25 Meter in Richtung Dorfplatz**, beim westlichen Gebäude um bis zu **5,90 Meter zur Niedersachsenstraße** und um **6,20 Meter in Richtung Kirchhofstraße**.',
                ],
            },
            {
                title: 'Wie bewertet die Verwaltung das Vorhaben?',
                paragraphs: [
                    'Die Verwaltung sieht durch die größere Geschossigkeit, die höheren Gebäude und die überschrittenen Baugrenzen **städtebauliche Spannungen** und spricht auch von **massiveren Baukörpern**. Gleichzeitig hält sie die beantragten Abweichungen für **vertretbar**.',
                    'Begründet wird dies unter anderem damit, dass der Bereich rund um den Dorfplatz inzwischen dichter bebaut sei. Das östliche Gebäude soll nach Einschätzung der Verwaltung außerdem den Dorfplatz räumlich fassen und die bestehenden gewerblichen Nutzungen ergänzen.',
                ],
            },
            {
